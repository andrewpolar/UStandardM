function [ yhat_all, fnB, fnT, RSME, t_min_all, t_max_all ] = buildKA_new( x, y, lab, identID, verifID, n, q, p, alp, Nrun, xmin, xmax, ymin, ymax, useInit, fnB0, fnT0 )
...
for jj=1:Nrun
    ...
    inds = ( lab == verifID );
    RSME(jj) = sqrt( sum( err_all(inds).^2 )/sum(inds) )/(ymax-ymin);
